...
/*
 * Remove the "Howdy" from the Admin Bar
 */
...
function ws_remove_post_meta_boxes() 
{
	...
	// remove_meta_box( 'submitdiv', 'post', 'normal' );					// Date, status, and update/save
...
function ws_remove_page_meta_boxes() 
{
	...
	// remove_meta_box( 'submitdiv', 'page', 'normal' );					// Date, status, and update/save
